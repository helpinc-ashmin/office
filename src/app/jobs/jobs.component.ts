...
export class JobsComponent implements OnInit {
  ...
  constructor() {
    ...
    this.registrations.push(new Registration('Ashmin', 'Dhungel', {year: 1996, month: 3, day: 4}, 'ashmin72@gmail.com', 'ashmin123', 'UK'));
    this.registrations.push(new Registration('Robin', 'Regmi', {year: 1990, month: 12, day: 3}, 'robin@gmail.com', 'robin123', 'UAE'));
    this.registrations.push(new Registration('Umesh', 'Thapa', {year: 1998, month: 7, day: 25}, 'umesh@gmail.com', 'umesh123', 'India'));
  }
